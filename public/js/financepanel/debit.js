        ...
        Datatable.dataTable = Datatable.table.DataTable({
            ...
            "columns":[
                {"data": null, "orderable": false, "render": function(data){
                    return data.alumn ? data.alumn.Matricula : 'Sin asignar'; 
                }},
                {"data": null, "orderable": false, "render": function(data){
                ...
                {"data": null, "orderable": false, "render": function(data){
                    return data.alumn ? data.alumn.plan_estudio.carrera.Nombre : "Sin asignar"; 
                }},
                {"data": null, "orderable": false, "render": function(data){
                    return data.alumn ? data.alumn.Localidad + ", " +data.alumn.estado.Nombre : "Sin asignar";
                }},
            ],
